...
nClients[2] = new Clients(3, 'Ім\'я 3 ','Призвіще 3 ','U2@email.com', `22-222-222`,['товар3',  'товар2', 'товар13', 'товар10']);
nClients[3] = new Clients(4, 'Ім\'я 4 ','Призвіще 4 ','U3@email.com', `33-333-333`,['товар4',  'товар2', 'товар3', 'товар10']);
nClients[4] = new Clients(5, 'Ім\'я 5 ','Призвіще 5 ','U4@email.com', `44-444-444`,['товар5',  'товар2', 'товар3', 'товар10', 'товар2', 'товар3', 'товар10']);
nClients[5] = new Clients(6, 'Ім\'я 6 ','Призвіще 6 ','U5@email.com', `555-111-11`,['товар6',  'товар2']);
nClients[6] = new Clients(7, 'Ім\'я 7 ','Призвіще 7 ','U6@email.com', `66511111  `,['товар7',  'товар2', 'товар3', 'товар10',  'товар2', 'товар3', 'товар10', 'товар3']);
nClients[7] = new Clients(8, 'Ім\'я 8 ','Призвіще 8 ','U7@email.com', `77-222-222`,['товар8']);
nClients[8] = new Clients(9, 'Ім\'я 9 ','Призвіще 9 ','U8@email.com', `88-333-333`,['товар9', 'товар2', 'товар3', 'товар10']);
nClients[9] = new Clients(10,'Ім\'я 10','Призвіще 10','U9@email.com', `99-444-444`,['т10', 'т2', 'т13', 'т11', 'т22', 'т3', 'т10','т2', 'т35', 'т10']);
