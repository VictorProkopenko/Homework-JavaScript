...
newUsers = newUsers.filter(a => a.id%2===0)
console.log(newUsers);
...
nClients[9] = new Clients(10,'Ім\'я 10','Призвіще 10','U9@email.com', `99-444-444`,'товар10 товар2 товар3 товар10 товар2товар10 товар2товар10 товар2');
